...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=192.168.0.111,1433;Database=TelemedUnividas;User Id=sa;Password=yourStrong(!)Password;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EspecialidadeEspecialistaClinica>(entity =>
            {
                ...
                entity.Property(e => e.EspecialisataCodigo).HasColumnName("especialisata_codigo");
                ...
                entity.HasOne(d => d.EspecialisataCodigoNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.EspecialisataCodigo)
                    .OnDelete(DeleteBehavior.ClientSetNull)
